 ...
 * Resources: retrieved from http://www.fanpop.com/clubs/random/articles/68087/title/100-interesting-facts
 */
public class FactsBank {

    public String getFact() {
        String[] factsBank;
        factsBank = new String[]{
                ...
                "1Chewing gum while peeling onions will keep you from crying. ",
        ...
        int randomNumber= generator.nextInt(factsBank.length);
        return factsBank[randomNumber];
    }
}
